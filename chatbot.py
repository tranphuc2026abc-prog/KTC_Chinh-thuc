...
from advanced_pdf_processor import process_pdf_advanced  # 🔥 NEW: Advanced PDF processing
...
class RAGEngine:
    ...
    def _read_and_process_files(pdf_dir: str) -> List[Document]:
        ...
        Bypasses naive RecursiveCharacterTextSplitter entirely.
        
        This method now directly calls process_pdf_advanced() which implements:
        ...
        for file_path in pdf_files:
            ...
            try:
                # 🔥 NEW: Use advanced processor directly on PDF
                file_chunks = process_pdf_advanced(
                    pdf_path=file_path,
                    chunk_size=1000,
                    overlap=100
                )
